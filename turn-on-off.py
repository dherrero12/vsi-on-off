...
def main(vsis): 
  ...
  api_key = 'FuPljp5eLHNh77IynN6gI8fVtaXCBeVVCF6QQP32arTU'
...
def getResources(token, vsis):
  ...
  conn.request('GET', '/v1/instances?generation=2&version=' + api_version, payload, headers)
  ...
  resourcejson = json.loads(data.decode('utf-8'))
...
if __name__ == '__main__':
  vsis = {'02d7_97a64596-7cf3-4b7d-b2a8-d28492311925': 'on'} 
  main(vsis)
